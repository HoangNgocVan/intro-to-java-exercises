...
public class SortPane extends Pane {
  ...
  private ArrayList<SelectionState> states;
  ...
  private void drawPane(boolean orig) {
    ...
    for (int i = 0; i < list.length; i++) {
      ...
      r.setFill(i == stateIndex && !orig ? Color.GRAY : Color.WHITE);
  ...
  private void set() {
    ...
    states =
      SelectionState.getStates(Arrays.copyOf(originalList, originalList.length));
    drawPane(true);
  }
